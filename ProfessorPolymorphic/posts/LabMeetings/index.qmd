...
1. Outbreak Simulator updates
2. Twinstick updates
3. New hires
4. Lab space assignments

## OUTBREAK SIMULATOR UPDATES

1. June 13-17, 2023: [ISLS meeting](https://www.isls.org/event/isls-annual-meeting-2023/) in Montreal.  [Interactive Demo Application](OutbreakSimulator-InteractiveDemo-2023v3.pdf) submitted.
2. Airports?
3. Project meeting (Monday?)

```{=html}
<iframe width="780" height="500" src="OutbreakSimulator-InteractiveDemo-2023v3.pdf" title="Interactive Demo"></iframe>
```

## TWINSTICK UPDATES

1. Landon shows us all the things.
2. Jonna shows us all the things.
