---
title: "AI and the Future of Education / Research / Academia..."
...
**How does this relate to research methods?**
...
::: {.column width="60%"}
![](AIFuture.mp4){.absolute .width="30%"}
:::
:::
...
![](Plospaper.png){.absolute height=500}

![](email.png){.absolute height=500 right=10}

## Claude v GPT

![](Opus.png){.absolute left=100 height="90%"}

![](GPT.png){.absolute right=100 height="90%"}
...
## Semantic Literature Analysis

[Tickbase.net](https://data.tickbase.net){target="blank"}
