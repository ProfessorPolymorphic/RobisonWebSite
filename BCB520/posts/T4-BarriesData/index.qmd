...
I'm going to try COMPARE TRENDS.  I want to COMPARE the TREND in `WalkSpeed` over time (`Generation`) between the two `Fit` categories.  To do this, I'll create a scatterplot, faceted by `Fit`.
