...
# **PROFESSIONAL APPLICATIONS IN DATA SCIENCE**

A graduate certificate that trains non-specialists how to think about, organize, analyze, and visualize data, and communicate data-driven insights to technical and lay audiences.
...
### **The University of Idaho's value proposition for a certificate in the Professional Applications in Data Science:**
...
#### BCB 5XX Communicating with Data (2 credits)
...
\*Note: This course could be divided into two 1 credit modules (verbal and written communication) which may facilitate online delivery and movement toward a stacking microcredential model.\*

#### BCB 5XX Data Visualization (3 credits)
...
Data Science is an applied field of study combining insights and techniques from multiple disciplines such as statistics, computer science, informatics, and social sciences. To maintain the interdisciplinary focus of the program, we propose housing the Professional Applications in Data Science certificate in the Bioinformatics and Computational Biology Program within the College of Science. Three of the required courses that will be created will use the BCB prefix. In addition, the BCB Administration (Director and Governing Board) and faculty are drawn from almost every College at the UI and are routinely called upon to consider curriculum and training from an interdisciplinary perspective.

### Governance and Oversight

The BCB Director, governing board, and faculty would have curricular control over the certificate content.

We recommend that the BCB Director or the Dean of the College of Science appoint a faculty coordinator for the certificate in Professional Applications in Data Science. The faculty coordinator will be responsible for guiding the certificate through curriculum approvals, helping recruit students, assessment, and coordinating with faculty who teach the included courses.

A subcommittee within BCB could also be appointed to help maintain the certificate's interdisciplinary focus and broad domain impact.
