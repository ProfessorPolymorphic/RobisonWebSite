...
-   Download and install R, [R-Studio](https://posit.co/downloads/), and Quarto (included by default with R-Studio).

-   [Create a Quarto document that will publish in the .html format](https://quarto.org/docs/output-formats/html-basics.html)

-   [Install the R packages you will need](https://www.dataquest.io/blog/install-package-r/)

-   [Tidy up the Anscombe's Quartet data](https://www.njtierney.com/post/2020/06/01/tidy-anscombe/)
