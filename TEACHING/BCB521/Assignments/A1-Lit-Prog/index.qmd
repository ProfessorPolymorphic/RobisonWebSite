...
date: "2023-08-21"
categories: [Assignment, Quarto, Literate Programming]
...
1.  Installing R and RStudio on your computer.
2.  Creating a quarto document.
3.  Executing some R code in that Quarto document.
4.  Rendering that document to .html.

We'll be evaluating your progress on this assignment in the class session on August 31, 2023.
...
Tableau is proprietary software that is very powerful for creating beautiful and functional data visualizations. It can integrate with all sorts of data sources and is used a lot for analytics, especially in the business world. The downsides (that occur to me at least) are that it costs money, it is not open source, and is more of a one-trick-pony than the programming languages on this list.  While Tableau is great for the Visualization part of Data Science, you'll need an actual programming language in your skill stack to really leverage what Tableau can do.
...
**Well, I want you to set up your publishing system and preferred language on your computer.**
...
Use that document to execute some R code.
...
[Michael Overton's R Tutorial](https://moverton.shinyapps.io/Tutorial_starting_R/)

[Handy cheat-sheets for many different R packages](https://posit.co/resources/cheatsheets/)

[Tutorial 1 - Literate Programming](https://professorpolymorphic.github.io/RobisonWebSite/BCB520/posts/T1-Lit-Prog/) Note that this is from a similar assignment from BCB 520 - Foundations of Data Visualization. You don't need to do the Anscombe's Quartet part, but feel free to give it a try!
